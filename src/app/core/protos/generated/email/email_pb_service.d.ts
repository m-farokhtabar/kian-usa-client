...
type EmailSrvSendCatalog = {
  ...
  readonly responseType: typeof email_pb.SendCatalogResponseMessage;
};
...
export class EmailSrvClient {
  ...
  sendCatalog(
    ...
    callback: (error: ServiceError|null, responseMessage: email_pb.SendCatalogResponseMessage|null) => void
  ): UnaryResponse;
  sendCatalog(
    requestMessage: email_pb.SendCatalogRequestMessage,
    callback: (error: ServiceError|null, responseMessage: email_pb.SendCatalogResponseMessage|null) => void
